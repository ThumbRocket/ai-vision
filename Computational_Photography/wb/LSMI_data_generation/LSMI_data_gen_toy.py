...
# img size (1048, 1048)
img1 = cv2.imread(os.path.join(current_file_directory, 'img1.png')) 
img12 = cv2.imread(os.path.join(current_file_directory, 'img12.png'))
img2 = img12 - img1
...
cv2.imwrite(os.path.join(current_file_directory, "wb_img1.png"), wb_img1)
cv2.imwrite(os.path.join(current_file_directory, "wb_img12.png"), wb_img12)